...
<div>
    <button wire:click="toggleLike" title="Aimer"
        class="like-button flex items-center text-gray-600 dark:text-gray-400 hover:text-red-500 mr-4 dark:hover:text-red-500 {{ $isLiked ? 'hover:!text-gray-900 dark:hover:!text-gray-300 dark:text-gray-300' : '' }}" 
        onclick="event.stopPropagation()">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="size-6 {{ $isLiked ? 'text-red-600 hover:text-gray-700 hover:fill-gray-700 dark:hover:!text-gray-100 dark:hover:fill-gray-100' : '' }}" fill="{{$isLiked ? 'red' : 'none'}}">
