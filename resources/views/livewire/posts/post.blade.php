...
<div>
    ...
    <div class="post bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4 p-6">
        ...
        <div class="post-actions mt-4 flex items-center">
            ...
            <!-- Reposter -->
            <button title="Reposter" class="repost-button flex items-center text-gray-600 dark:text-gray-400 hover:text-green-400 dark:hover:text-blue-500 mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <!-- Partager -->
            <button title="Partager" class="share-button flex items-center text-gray-600 dark:text-gray-400 hover:text-yellow-500 dark:hover:text-green-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
