...
<div>
    ...
    <div class="max-w-5xl mx-auto px-3 sm:px-8">
        <div class="post bg-white dark:bg-gray-800 shadow-sm rounded-lg mb-4 md:p-5 p-2 md:mb-5 w-full">
            <div class="flex items-center justify-between">
                ...
                <div
                    ...
                    <div class="relative">
    <button 
        onclick="toggleDropdown({{$matchedUser->id}})" 
    ...
    <div 
        id="dropdownMenu_{{ $matchedUser->id }}" 
        class="dropdownMenu hidden absolute w-max bg-gray-700 dark:bg-gray-900 rounded-md shadow-lg z-50 max-h-48 overflow-auto">
