...
<div>
    @foreach ($matchedUsers as $matchedUser)
        <div class="max-w-5xl mx-auto px-3 sm:px-8 2xl:mt-0">
            <div class="post bg-white dark:bg-gray-800 overflow-visible shadow-sm rounded-lg md:p-5 p-2 md:mb-5 mb-3 w-full">
                <div class="flex sm:justify-normal justify-around sm:items-center items-start sm:flex-row flex-row sm:pt-0 pt-4">
                    ...
                    @else
                    <div
                        class="sm:mt-1 sm:!ml-auto !ml-0 items-start self-start dark:!text-gray-100 transition duration-300 ease-in-out">
                            <div id="dropdownMenu_{{ $matchedUser->id }}" title="Plus d'actions..." 
                                class="sm:mt-1 sm:!ml-auto !ml-0 items-start self-start dark:!text-gray-100 transition duration-300 ease-in-out"> 
