...
new class extends Component
{
    ...
    {
        $additionalUsers = User::find(auth()->id())->followers()
            ->where('id', '!=', auth()->id())
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <div class="flex flex-row">
                                <a href="/user/{{$followingUser->id}}" class="hover:underline mr-2"><h2 class="text-xl font-semibold text-black dark:text-gray-100">{{ $matchedUser->name }}</h2></a>
                                @auth
                            ...
                            <p class="text-black dark:text-gray-100">Abonnés : {{ $followingUser->followers()->count() }}</p>
                            <p class="text-black dark:text-gray-100">Abonnements : {{ $followingUser->followed_users()->count() }}</p>
                        </div>
                    </div>
