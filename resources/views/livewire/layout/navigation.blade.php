    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="items-center content-center mx-6 w-72 " x-data="{ query: '' }">
                <form action="" method="GET" class="relative w-full flex flex-row dark:!text-gray-100">
                    ...
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none dark:!text-gray-100">
                        <svg class="w-5 h-5 text-gray-500 dark:!text-white/65" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            @auth
                            <img src="{{ auth()->user()->avatar ?? 'path/to/default/avatar.png' }}" alt="Profile Image"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <a wire:navigate href="{{ route('profile') }}">
                <div class="px-4 flex flex-row items-center">
                    @auth
                    <img src="{{ $post->user->avatar ?? 'path/to/default/avatar.png' }}" alt="Profile Image"
                        class="w-8 h-8 rounded-full mr-4 shadow-lg">
