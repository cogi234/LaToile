<div id="post-{{ $post->id }}" onclick="window.open('/post/{{ $post->id }}', '_blank')" {{ $attributes->merge(['class'
    => "cursor-pointer post bg-white hover:bg-white/50 dark:bg-gray-800 dark:hover:dark:bg-gray-700 overflow-hidden
    shadow-sm rounded-lg mb-4 md:p-5 p-2 md:mb-5 mb-3 w-full"]) }}>
...
<div id="editPostModal"
    ...
    <div
        class="modal-content top-1/4 w-2/4 p-4 pt-2 mx-auto bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
